function Banner() {
    return (
        <section className="h-full my-20 overflow-hidden">
            <div className="h-[400px] bg-slate-900 flex flex-row justify-center items-center">
                ...
                <div className="flex-[2] text-slate-200 pl-8 md:px-8">
                    ...
                    <div className="w-full max-w-sm min-w-[200px] mt-4 md:mt-8 border-b-2 border-b-slate-500">
                        <div className="relative">
                            <input 
                            type="email" 
                            className="w-full border-x-0 border-y-0 bg-transparent placeholder:text-slate-300 text-slate-200 text-sm border border-b-slate-400 rounded-md pl-3 pr-16 py-2 transition duration-300 ease focus:outline-none focus:border-b-slate-400 hover:border-b-slate-300 shadow-sm focus:shadow" placeholder="Email Address" />
                            <button
                                className="absolute right-1 top-1 text-center text-sm text-white font-Montserrat"
                                type="button"
                            >
                                Sign Up
                            </button>
